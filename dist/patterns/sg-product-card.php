...
return array(
    ...
    <article class="grid gy-2  sg-product-card"><!-- wp:sg/featured-image {"sizes":{"default":768},"fullWidth":true} /-->
    
    <!-- wp:sg/container {"layout":"grid","columns":{"default":1},"className":"sg-product-card__container"} -->
